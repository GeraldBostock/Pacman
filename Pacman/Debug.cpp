...
void Debug::init(SDL_Renderer* renderer, int windowWidth, int windowHeight)
{
	...
	m_fire.init(25, 25, "fire.png", renderer, 4, 0.03f, 0.2f);
}

void Debug::draw(SDL_Renderer* renderer, int windowWidth, int windowHeight, int posX, int posY, int appleNum)
{
	...
	m_appleCount.draw(215, 100, renderer, NULL, 0.0);
